...
import org.geogebra.common.kernel.prover.ProverCNIMethodReal;import org.geogebra.common.kernel.prover.ProverPureSymbolicMethod;
...
public abstract class Prover {
	...
	private void callEngine(ProverEngine currentEngine) {
		...
		if (currentEngine == ProverEngine.BOTANAS_PROVER) {
			...
			result = override(ProverCNIMethod.prove(this, ProverCNIMethodReal::new)); // !!
			return;
		}
	}
