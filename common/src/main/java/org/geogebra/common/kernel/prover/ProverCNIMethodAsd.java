...
public class ProverCNIMethodAsd {
	...
	public ProofResult prove(ProverContext context){
		...
		if (def.realRelation != null) {
			...
			if (context.prover.getShowproof()) {
				...
				context.prover.addProofLine(CmdShowProof.EQUATION, VARIABLE_R_STRING + Constants.PRIME + ":=" + lhs2);
		...
		if (minDegreeI == 1) {
			...
			if (minDegree2I == 1) {
				...
				if (context.prover.getShowproof()) {
					...
					context.prover.addProofLine(CmdShowProof.EQUATION, VARIABLE_R_STRING + Constants.PRIME + Constants.PRIME + ":=" + rExpr2Primed);
	 ...
	 */
	ProverCNIMethodAsd.CNIDefinition getCNIHypothesisDefinition(GeoElement ge) {
	 ...
	 * @return all required information for the CNI definition for the input
	 */
	ProverCNIMethodAsd.CNIDefinition getCNIThesisDefinition(GeoElement ge) {
		ProverCNIMethodAsd.CNIDefinition c = new ProverCNIMethodAsd.CNIDefinition();
		AlgoElement ae = ge.getParentAlgorithm();
